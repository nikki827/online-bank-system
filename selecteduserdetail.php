...
<body>
    ...
    <div class="container">
        ...
        ?>
        <form class="form-container px-3" method="post" name="tcredit" style=" background-color: #f7f1ee;"><br>
    ...
    <footer class="text-center mt-5 py-2">
        <p style="font-family: poppins; font-size: 16px;">&copy 2021. Developed by <b>Nikita Gupta</b> <br> Sparks Foundation</p>
    </footer>
